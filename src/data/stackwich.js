...
/**
 * The fourteen numbered stops on the Stackwich Kingdom map (Book 6: the
 ...
 */
export const STACKWICH_PLACES = [
  {
    id: "cheese-road", n: 1, x: 8, y: 7, ink: C.butter,
    name: "The Cheese Road", who: "First steps into Stackwich", kind: "Sky path",
    intro: "A sparkling ribbon of melted-cheese magic that climbs from Snackville high above the clouds.",
    d: "Piper and the Snack Squad follow it on their flying toast boards as they begin their journey to Stackwich Kingdom. The higher the road climbs, the more the familiar world below disappears into purple cloud.",
  },
  {
    id: "cloud-landing", n: 2, x: 28, y: 11, ink: C.sky,
    name: "Cloud Landing", who: "Travellers arriving by cloud", kind: "Landing point",
    intro: "The first safe landing point in Stackwich Kingdom, floating beside Sandwich Castle among soft violet clouds.",
  ...
  },
  {
    ...
    intro: "The magnificent heart of Stackwich Kingdom.",
  ...
  {
    id: "tomato-tunnels", n: 7, x: 14, y: 42, ink: C.strawberry,
  ...
  {
    id: "scratched-wall", n: 8, x: 27, y: 57, ink: C.strawberry,
  ...
  {
    id: "great-bread-forest", n: 9, x: 61, y: 51, ink: C.grape,
  ...
  {
    id: "toast-cottage", n: 10, x: 88, y: 59, ink: C.ember,
  ...
  {
    id: "hidden-staircase", n: 11, x: 58, y: 64, ink: C.grape,
    ...
    d: "It spirals beneath the Great Bread Forest and marks the beginning of the journey into the forgotten foundations below the kingdom. Few visitors to Stackwich Kingdom even know that it exists.",
  },
  {
    id: "beneath-bread-forest", n: 12, x: 33, y: 74, ink: C.cocoa,
  ...
  {
    id: "cheese-caves", n: 13, x: 49, y: 77, ink: C.cocoa,
    name: "The Cheese Caves", who: "Deep beneath the kingdom", kind: "Caves",
    intro: "Warm golden caves glowing with magical cheese light deep beneath Stackwich Kingdom.",
  ...
  {
    id: "crumblys-cave", n: 14, x: 79, y: 79, ink: C.cocoa,
